...
export class PadraoComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.carnes = [
      ...
      { label: 'Hamburguer de carne', value: '1 unidade' },
      { label: 'Hamburguer de frango', value: '1 unidade' },
      { label: 'Hamburguer de peru', value: '1 unidade' },
      { label: 'Linguiça', value: '1 gomo' },

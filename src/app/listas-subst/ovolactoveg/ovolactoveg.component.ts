...
@Component({
  selector: 'app-ovolactoveg',
  templateUrl: './ovolactoveg.component.html',
  styleUrls: ['./ovolactoveg.component.scss']
})
export class OvolactovegComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.carnes = [
      { label: 'Almondega de soja', value: '4 unidades' },
      { label: 'Bife de soja', value: '2 unidades' },
      { label: 'Hamburguer de soja', value: '1 unidade' },
      { label: 'Kibe de soja', value: '2 unidades média' },
    ...
    this.cereal = [
      ...
      { label: 'Pão francês s/ miolo', value: '1 unidade' },
